...
int64_t rsa_krypter(int m, int e, int n) {
    return mod_exp((int64_t)m, e, n);
}

void rsa_krypter_tekst(char *tekst, int64_t *krypteret_tekst, int streng_længde, int e, int n) {
...
double rsa_dekrypter(int64_t c, int d, int n) {
    return mod_exp(c, d, n);
}

void rsa_dekrypter_tekst(int64_t *krypteret_tekst, char *dekrypteret_tekst, int streng_længde, int d, int n) {
    for (int i = 0; i < streng_længde; i++) {
